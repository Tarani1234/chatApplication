...
const ChatContainer = ({ selectedUser, setSelectedUser }) => {
  return selectedUser ? (
            ...
            {msg.image ? (
              ...
              <div className="text-center text-xs ">
                   <img src={msg.senderId === '680f5116f10f3cd28382ed02' ?
                    assets.avatar_icon : assets.profile_martin} alt="" className="w-8 rounded-full "/>
    ...
    <div className="flex flex-col items-center justify-center h-full text-gray-500 bg-white/10 mx-md:hidden">
